...
<div class="container">
	...
	<div class="recipe">
		...
		<div>
			<div>Total water:</div> <div>{totalWater} ml</div>
		</div>
		<div>
			<div>Tea bags:</div> <div>{teaBags}</div>
		</div>
		<div>
			<div>Sugar:</div> <div>{sugar} g</div>
		</div>
		<div>
			<div>Starter Liquid:</div> <div>{starterLiquid} ml</div>
		</div>
		<div>
			<div>Scoby Size:</div> <div>{scobySize} g</div>
		</div>
	</div>
</div>
